...
- **Centralised identity data**: When you add a configuration to an existing Account to enable additional functionality, you don’t have to re-collect requirements that they already provided.
...
Stripe still supports the Accounts v1 and Customers v1 APIs. However, you can [use the Accounts v2 API to manage Accounts created using the Accounts v1 API](https://docs.stripe.com/connect/accounts-v2/migrate-integration.md), including assigning them the `customer` configuration.
